namespace Database_Project
{
	partial class SearchForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.balance_err = new System.Windows.Forms.Label();
			this.SuspendLayout();
			// 
			// search_textBox
			// 
			...
			// balance_err
			// 
			this.balance_err.AutoSize = true;
			this.balance_err.ForeColor = System.Drawing.Color.Red;
			this.balance_err.Location = new System.Drawing.Point(249, 516);
			this.balance_err.Name = "balance_err";
			this.balance_err.Size = new System.Drawing.Size(0, 13);
			this.balance_err.TabIndex = 5;
			// 
			// SearchForm
			// 
			...
			this.Controls.Add(this.balance_err);
        ...
        private System.Windows.Forms.Label balance_err;
    }
}